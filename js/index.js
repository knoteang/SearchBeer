    ...
    .then(response => {
        ...
        for (let i = 0; i < result.length; i++) {
          ...
          '<div style="word-wrap: break-word;padding: 10px;background-color:white;margin:4% 4% 4% 4%;opacity:0.8;text-align:canter;" class="col-md-3">'+
            ...
            '<p style="font-size:20px;font-weight: bold;text-align:left;padding-top:50px;">Description : '+result[i].description+'</p>'+
            '<p style="font-size:20px;font-weight: bold;text-align:left;">First brewed : '+result[i].first_brewed+'</p>'+
            '<p style="font-size:20px;font-weight: bold;text-align:left;">Tagline : '+result[i].tagline+'</p>'+
            '<p style="font-size:20px;font-weight: bold;text-align:left;">Yeast : '+result[i].ingredients.yeast+'</p>'+
            '<p style="font-size:20px;font-weight: bold;text-align:left;">Food pairing : '+result[i].food_pairing+'</p>'+
            '</div>';
        }
      });
